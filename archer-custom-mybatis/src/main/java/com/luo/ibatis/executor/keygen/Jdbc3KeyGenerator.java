...
public class Jdbc3KeyGenerator implements KeyGenerator {
  ...
  public void processBatch(ArcherMappedStatement ms, Statement stmt, Collection<Object> parameters) {
    ResultSet rs = null;
    try {
      rs = stmt.getGeneratedKeys();
      final ArcherConfiguration configuration = ms.getConfiguration();
      final ArcherTypeHandlerRegistry typeHandlerRegistry = configuration.getTypeHandlerRegistry();
  ...
  private TypeHandler<?>[] getTypeHandlers(ArcherTypeHandlerRegistry typeHandlerRegistry, MetaObject metaParam, String[] keyProperties, ResultSetMetaData rsmd) throws SQLException {
