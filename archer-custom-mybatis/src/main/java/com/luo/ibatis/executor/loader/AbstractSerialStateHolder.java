...
public abstract class AbstractSerialStateHolder implements Externalizable {
  ...
  private Map<String, ArcherResultLoaderMap.LoadPair> unloadedProperties;
  ...
  public AbstractSerialStateHolder(
          ...
          final Map<String, ArcherResultLoaderMap.LoadPair> unloadedProperties,
          final ObjectFactory objectFactory,
          List<Class<?>> constructorArgTypes,
          List<Object> constructorArgs) {
    this.userBean = userBean;
    this.unloadedProperties = new HashMap<String, ArcherResultLoaderMap.LoadPair>(unloadedProperties);
  ...
  protected final Object readResolve() throws ObjectStreamException {
    ...
    try {
      ...
      this.unloadedProperties = (Map<String, ArcherResultLoaderMap.LoadPair>) in.readObject();
    ...
    final Map<String, ArcherResultLoaderMap.LoadPair> arrayProps = new HashMap<String, ArcherResultLoaderMap.LoadPair>(this.unloadedProperties);
  ...
  protected abstract Object createDeserializationProxy(Object target, Map<String, ArcherResultLoaderMap.LoadPair> unloadedProperties, ObjectFactory objectFactory,
