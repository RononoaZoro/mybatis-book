 ...
 */
public abstract class ArcherBaseStatementHandler implements ArcherStatementHandler {

    protected final ArcherConfiguration configuration;
    protected final ObjectFactory objectFactory;
    protected final ArcherTypeHandlerRegistry typeHandlerRegistry;
    protected final ArcherResultSetHandler resultSetHandler;
    protected final ArcherParameterHandler parameterHandler;

    protected final ArcherExecutor executor;
    protected final ArcherMappedStatement mappedStatement;
    protected final ArcherRowBounds rowBounds;

    protected ArcherBoundSql boundSql;

    protected ArcherBaseStatementHandler(ArcherExecutor executor, ArcherMappedStatement mappedStatement, Object parameterObject, ArcherRowBounds rowBounds, ArcherResultHandler resultHandler, ArcherBoundSql boundSql) {
