...
public class BatchResult {
  ...
  public BatchResult(ArcherMappedStatement mappedStatement, String sql) {
    super();
  ...
  public BatchResult(ArcherMappedStatement mappedStatement, String sql, Object parameterObject) {
    this(mappedStatement, sql);
    addParameterObject(parameterObject);
  }

  public ArcherMappedStatement getMappedStatement() {
