...
public class UnknownTypeHandler extends BaseTypeHandler<Object> {
  ...
  private ArcherTypeHandlerRegistry typeHandlerRegistry;

  public UnknownTypeHandler(ArcherTypeHandlerRegistry typeHandlerRegistry) {
  ...
  private Class<?> safeGetClassForColumn(ResultSetMetaData rsmd, Integer columnIndex) {
    try {
      return ArcherResources.classForName(rsmd.getColumnClassName(columnIndex));
    } catch (Exception e) {
      return null;
    }
  }
