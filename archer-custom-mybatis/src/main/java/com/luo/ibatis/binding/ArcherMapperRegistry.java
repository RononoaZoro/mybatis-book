...
public class ArcherMapperRegistry {
    ...
    private final Map<Class<?>, ArcherMapperProxyFactory<?>> knownMappers = new HashMap<Class<?>, ArcherMapperProxyFactory<?>>();
    ...
    public <T> T getMapper(Class<T> type, ArcherSqlSession sqlSession) {
        final ArcherMapperProxyFactory<T> mapperProxyFactory = (ArcherMapperProxyFactory<T>) knownMappers.get(type);
    ...
    public <T> void addMapper(Class<T> type) {
        if (type.isInterface()) {
            ...
            try {
                knownMappers.put(type, new ArcherMapperProxyFactory<T>(type));
