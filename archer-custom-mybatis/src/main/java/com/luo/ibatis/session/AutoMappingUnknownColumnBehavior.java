...
public enum AutoMappingUnknownColumnBehavior {
  ...
  NONE {
    @Override
    public void doAction(ArcherMappedStatement mappedStatement, String columnName, String property, Class<?> propertyType) {
      // do nothing
    }
  },
   ...
   * Logger
   */
  private static final Log log = ArcherLogFactory.getLog(AutoMappingUnknownColumnBehavior.class);
   ...
   * @param propertyType property type for mapping target (If this argument is not null, {@link TypeHandler} for property type is not registered)
     */
  public abstract void doAction(ArcherMappedStatement mappedStatement, String columnName, String propertyName, Class<?> propertyType);

  /**
   * build error message.
   */
  private static String buildMessage(ArcherMappedStatement mappedStatement, String columnName, String property, Class<?> propertyType) {
