...
public abstract class DbUtils {
    ...
    public static Connection initData() {
        ...
        try {
            ...
            scriptRunner.runScript(ArcherResources.getResourceAsReader("create-table.sql"));
            scriptRunner.runScript(ArcherResources.getResourceAsReader("init-data.sql"));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return conn;
