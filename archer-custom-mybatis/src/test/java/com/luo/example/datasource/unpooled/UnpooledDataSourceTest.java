 ...
 */
package com.luo.example.datasource.unpooled;
...
public class UnpooledDataSourceTest {
  ...
  public void shouldNotRegisterTheSameDriverMultipleTimes() throws Exception {
    ...
    ArcherUnpooledDataSource dataSource = null;
    dataSource = new ArcherUnpooledDataSource("org.hsqldb.jdbcDriver", "jdbc:hsqldb:mem:multipledrivers", "sa", "");
  ...
  public void shouldRegisterDynamicallyLoadedDriver() throws Exception {
    ...
    dataSource = new ArcherUnpooledDataSource(driverClassLoader, "com.mysql.jdbc.Driver", "jdbc:mysql://127.0.0.1/test", "root", "");
    dataSource.getConnection().close();
