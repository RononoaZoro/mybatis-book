 ...
 */
package com.luo.example.scripting;
...
public class LanguageDriverRegistryTest {
  ...
  public void registerByTypeDoesNotCreateNewInstance() {
    ...
    then(caughtException()).isInstanceOf(ScriptingException.class)
      .hasMessage("Failed to load language driver for com.luo.example.scripting.LanguageDriverRegistryTest$PrivateLanguageDriver");
  }
