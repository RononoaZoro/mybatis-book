...
import com.luo.example.domain.blog.Author;
import com.luo.example.domain.misc.CustomBeanWrapper;
import com.luo.example.domain.misc.CustomBeanWrapperFactory;
import com.luo.example.domain.misc.RichType;
...
public class MetaObjectTest {
  ...
  public void shouldVerifyPropertyTypes() {
    ...
    assertEquals(ReflectorTest.Section.class, object.getGetterType("favouriteSection"));
  }
