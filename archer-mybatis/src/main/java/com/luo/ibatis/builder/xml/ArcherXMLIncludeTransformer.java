...
public class ArcherXMLIncludeTransformer {

    private final ArcherConfiguration configuration;
    private final ArcherMapperBuilderAssistant builderAssistant;

    public ArcherXMLIncludeTransformer(ArcherConfiguration configuration, ArcherMapperBuilderAssistant builderAssistant) {
